      ...
      <div>
        <Router>
          ...
          <Switch>
            ...
            <Route exact path="/entertainment"><News key="entertainment" pageSize={15} country="in" catego exactry="entertainment"/></Route>
            <Route exact path="/general"><News key="general" pageSize={15} country="in" catego exactry="general"/></Route>
